...
// SPK v6.7: Temporary remote diagnostic logger for the iOS Inicis flow.
...
func createWebView(container: UIView, WKSMH: WKScriptMessageHandler, WKND: WKNavigationDelegate, NSO: NSObject, VC: ViewController) -> WKWebView{
    ...
    // SPK v6.7 A/B TEST:
    // Restore the exact User-Agent pattern generated by the latest PWABuilder iOS template.
    // No other payment/WebView behavior is changed in this test.
